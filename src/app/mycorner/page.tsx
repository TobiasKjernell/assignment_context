        ...
        <div className="flex flex-col h-full bg-[url(/login.webp)] text-white" >
            ...
            <div className="flex h-full flex-col lg:flex-row">
                <div className="flex-[1_0_33] bg-black/50 ">
                    <h3 className="text-center text-2xl p-2 mb-2 underline">Favourite category</h3>
                ...
                <div className="flex-[1_0_33] bg-black/50 border-l-1 border-amber-50">
                    <h3 className="text-center text-2xl p-2 mb-2 underline">Favourite recipes</h3>
                  ...
                  <div className="flex-[1_0_33] bg-black/50 border-l-1 border-amber-50">
                    <h3 className="text-center text-2xl p-2 mb-2 underline">Favourite countries</h3>
